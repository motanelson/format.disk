...
# Total de setores
boot_sector[19:21] = (5760).to_bytes(2, 'little')

# Media descriptor (F0 = disquete)
boot_sector[21] = 0xF0

# Setores por FAT
boot_sector[22:24] = (18).to_bytes(2, 'little')

# Setores por trilho
boot_sector[24:26] = (36).to_bytes(2, 'little')
...
with open(i, "wb") as f:
    f.write(boot_sector)
    f.write(b"\x00" * ((1474560 * 2) - 512))

print("Imagem FAT12 2.88MB criada.")
