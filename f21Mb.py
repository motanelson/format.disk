...
# Entradas de root
boot_sector[17:19] = (240).to_bytes(2, 'little')

# Total de setores
boot_sector[19:21] = (43008).to_bytes(2, 'little')

# Media descriptor (F0 = disquete)
boot_sector[21] = 0xF0

# Setores por FAT
boot_sector[22:24] = (288).to_bytes(2, 'little')

# Setores por trilho
boot_sector[24:26] = (72).to_bytes(2, 'little')
...
with open(i, "wb") as f:
    f.write(boot_sector)
    f.write(b"\x00" * ((1024*1024*21) - 512))

print("Imagem FAT12 21.0MB criada.")
